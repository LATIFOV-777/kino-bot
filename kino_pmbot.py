...
async def main():
    ...
    app.add_handler(MessageHandler(filters.TEXT & (~filters.COMMAND), handle_code))  # Qo‘shildi

    # async def main():
    #     app = ApplicationBuilder().token(TOKEN).build()
    #
    #     # Bu yerda komandalarni ro‘yxatdan o‘tkazamiz:
    #     # await app.bot.set_my_commands([
    #     #     BotCommand("start", "Botni ishga tushirish"),
    #     #     BotCommand("info", "Bot haqida ma'lumot"),
    #     #     BotCommand("admin", "Admin menyusi"),
    #     #     BotCommand("sendall", "Xabar yuborish (admin)"),
    #     #     BotCommand("add", "Kod qo‘shish (admin)"),
    #     #     BotCommand("del", "Kod o‘chirish (admin)"),
    #     #     BotCommand("list", "Kodlar ro‘yxati (admin)"),
    #     # ])
    #
